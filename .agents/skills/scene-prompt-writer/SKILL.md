...
## Detailed Research & Generation Workflow (from AGENTS.md)
...
python .Codex/scripts/pexels_search.py "<scene type> <time> <mood>"
...
```bash
LINKAPI_KEY="<key>" python .Codex/scripts/gen_api.py image \
...
PICUI_API_TOKEN="<token>" python .Codex/scripts/picui_upload.py upload \
